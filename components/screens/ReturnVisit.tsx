...
export function ReturnVisit({ saved, setState }: Props) {
  ...
  return (
    <section className="max-w-screen mx-auto">
      ...
      <p className="muted text-xs mt-6" style={{ maxWidth: '60ch' }}>
        Update walks you through the flow again with your saved answers pre-filled. Change only what&rsquo;s different. We save over the previous Signature when you finish.
      </p>
    </section>
  );
}
